...
class AuthProvider extends ChangeNotifier {
  ...
  int? get sandboxBranchId => _user?.sandboxBranchId;
  bool get sandboxMode => _sandboxMode;

  int? get effectiveBranchId {
    if (_sandboxMode && _user?.sandboxBranchId != null) {
      return _user!.sandboxBranchId;
    }
    return _user?.branchId;
  }

  void enableSandboxMode() {
    if (!_sandboxMode) {
      _sandboxMode = true;
      print("sandboxMode je sada" + _sandboxMode.toString());
